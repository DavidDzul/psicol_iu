...
import { Admin, Calendar, Generation, UpdateCalendarInput } from "@/grapqhl"
...
const { defineField, meta, values, resetForm, setValues } = useForm<UpdateCalendarInput>({
...
const props = defineProps({
  ...
  editItem: { type: Object as PropType<Calendar>, required: false },
})

const emit = defineEmits<{
  "update:modelValue": [value: boolean]
  submit: [value: UpdateCalendarInput]
}>()
...
watch(
  ...
  (value) => {
    if (!value) {
      ...
      const formatDate = dayjs(value.date)
